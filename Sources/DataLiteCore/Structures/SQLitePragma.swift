...
///
/// The `SQLitePragma` structure provides a convenient way to work with
...
public struct SQLitePragma: RawRepresentable, CustomStringConvertible, ExpressibleByStringLiteral {
    ...
    public static let applicationID: SQLitePragma = "application_id"
    ...
    ///
    /// This initializer allows you to create a `SQLitePragma` instance with any raw string
    ...
    ///
    /// This initializer allows you to create a `SQLitePragma` instance using a string literal,
